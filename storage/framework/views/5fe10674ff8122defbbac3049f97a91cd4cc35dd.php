...
<?php $__env->startSection('content'); ?>
            ...
            <ul class="r">
                ...
                <?php else: ?>
                    <div class="default-address-xq">
                        <ul class="r-t flex-between font-14 color-50">
                            <li >联系人：<span class="m-shr"><?php echo e($default_address->recipient_name); ?></span></li>
                            <li  class="m-sj">电话：<?php echo e($default_address->mobile); ?></li>
                        </ul>
    ...
    <div class="location-border">
        <div>
            <li>
                ...
                <input type="hidden" id="months" value="<?php echo e($months); ?>"/>
                <input type="hidden" id="spuId" value="<?php echo e($spuId); ?>"/>
            </li>
        </div>
        ...
        <?php $__currentLoopData = $skus_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sku): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
            <div class="goods-has-select flex-unbetween b-white test1">
                ...
                <?php $__currentLoopData = $sku['sku_spec']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guige): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <input type="hidden" value="<?php echo e($guige); ?>"/>
    ...
    <div class="giving b-white" >
        <ul>
            <textarea id="textarea" placeholder=""  style="width:100%;height:60px;border:solid 1px #e8e8e8;;box-shadow: inset 0 0px 0px rgb(255,255,255);background-color: white;margin-top: 4px;"></textarea>
        </ul>
    </div>
    ...
    <div class="xq-lb">
        <div class="title-zeng">
            <p class="text-center">选择服务/收货地址</p>
        ...
        <div class="add-address-btn col-xs-12 model-add">
            ...
            <span class="f16 fz col-xs-10" style="margin-left:9px;">新增服务/收货地址</span>
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(asset('ys_js/ysorder_confirm_pay.js')); ?>"></script>
