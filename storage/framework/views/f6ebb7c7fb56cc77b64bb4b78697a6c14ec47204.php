...
<div class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-primary b-white">
    <a class="mui-control-item  font-12 <?php if(empty($state)): ?> mui-active <?php endif; ?>" href="/order/index">全部</a>
    <a class="mui-control-item font-12 color-80 <?php if($state == '1'): ?> mui-active <?php endif; ?>" href="/order/index/1">待付款</a>
    <a class="mui-control-item font-12 color-80 <?php if($state == '2'): ?> mui-active <?php endif; ?>" href="/order/index/2">待发货</a>
    <a class="mui-control-item font-12 color-80 <?php if($state == '3'): ?> mui-active <?php endif; ?>" href="/order/index/3">待收货</a>
    <a class="mui-control-item font-12 color-80 <?php if($state == '9'): ?> mui-active <?php endif; ?>" href="/order/index/9">已完成</a>
</div>
                    ...
                    <ul class="flex-end">
                        ...
                        <?php elseif($order_info['plat_order_state']==2): ?>
                            ...
                            <?php if($order_info['is_get_gift'] == 0): ?>
                                ...
                                <?php if($order_info['is_share_gifts'] == 0): ?>
                                    <a href="/order/applyRefund/<?php echo e($order_info['plat_order_id']); ?>"><li class="refund-order111 flex-center" order="<?php echo e($order_info['plat_order_id']); ?>">申请退单</li></a>
                                <?php endif; ?>
                            <?php endif; ?>
