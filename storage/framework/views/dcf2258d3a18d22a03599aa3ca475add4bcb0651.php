    ...
    <div id="tab2">
        <?php if(!$logs): ?>
            <div style="margin:0 auto;height:200px;width:200px;margin-top:140px;text-align: center">
                <img style="width:47%" src="<?php echo e(asset('img/default_shuitine.png')); ?>">
        ...
        <?php else: ?>
            <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                <div class="detail">
                    <ul class="detail-1">
                        <li style="margin-left: 2%"><?php echo e($log['create_time']); ?></li>
                        <li style="margin-right: 2%"><?php echo e($log['busine_type']); ?></li>
                    </ul>

                    <ul class="detail-2">
                        <li style="margin-left: 2%;color: <?php echo e($log['color']); ?>"><?php echo e($log['av_amount']); ?></li>
                        <li style="margin-right: 2%">可用余额：<span><?php echo e($log['realtime_balance']); ?></span></li>
                    </ul>
                </div>
