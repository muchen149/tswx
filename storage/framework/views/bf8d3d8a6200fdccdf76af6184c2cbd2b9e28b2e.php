...
<?php else: ?>
    ...
    <?php $__currentLoopData = $skus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sku): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
        <div class="goods-list b-white">
            <ul class="l" >
                <li class="turn-status2" cart_id="<?php echo e($sku['cart_id']); ?>">
                </li>
            </ul>
            <ul class="m">
                <a href="<?php echo e(url('/sd_shop/goods/spuDetail/'.$sku['spu_id'])); ?>">
                    <li ><img src="<?php echo e(asset($sku['main_img'])); ?>" alt=""></li>
                </a>
            </ul>
            <ul class="r">
                <a href="<?php echo e(url('/sd_shop/goods/spuDetail/'.$sku['spu_id'])); ?>">
                    <li class="goods-title font-12 color-50"><?php echo e($sku['sku_name']); ?></li>
                </a>

                <li class="property font-12 color-120">
                    <?php if( !empty($sku['sku_spec']) ): ?>
                        规格:
                ...
                <ul class="p-c flex-between font-14">
                    <li class="prize ">
                        ¥&nbsp;<span class="g_price"><?php echo e($sku['price']); ?></span>
                    </li>
                    <li class="count color-80">
                        X&nbsp;<span class="buy_num"><?php echo e($sku['number']); ?></span>
                    </li>
                </ul>
            </ul>
            <ul class="car-editor" style="display: none">
                <ul class="add-min flex-between">
                    ...
                    <input type="text" value="<?php echo e($sku['number']); ?>" class="font-16 font-ber color-80 quantity" cart_id="<?php echo e($sku['cart_id']); ?>">
...
<form action="<?php echo e(asset('/order/showPay')); ?>" method="post" id="jsform">
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(asset('sd_js/cart/cart_list.js')); ?>"></script>
