...
<body>
        ...
        <div class="flex-between">
            ...
            <ul class="r">
                <ul class="r-t flex-between font-14 color-50">
                    <li >收货人:<span><?php echo e($order_address['recipient_name']); ?></span></li>
                    <li><?php echo e($order_address['mobile']); ?></li>
                </ul>
                <li class="r-b font-12 color-80">收货地址：
                <span>
                    <?php echo e($order_address['address']); ?>
  ...
  <?php endif; ?>
    ...
    <div class="order-discount">
        ...
        <?php endif; ?>
        <?php if(isset($order_info['payment']['org_pay_card'])): ?>
            <ul class="font-12 color-160 flex-between">
                <li>机构折扣</li>
                <li>-¥<?php echo e($order_info['payment']['org_pay_card']['pay_amount']); ?></li>
            </ul>
        <?php endif; ?>
