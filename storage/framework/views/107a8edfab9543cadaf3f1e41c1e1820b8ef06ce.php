...
<?php $__env->startSection('content'); ?>
    ...
    <div class="s-listAll" id="product_list">
            ...
            <div id="item1" class="mui-control-content mui-active">
                ...
                <ul class="clearFix">
                <?php $__currentLoopData = $label_goods_list[0]['g_list']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $good_info): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <li>
                            <a href="<?php echo e(url('elife/goods/spuDetail/'.$good_info['spu_id'])); ?>"><img src="<?php echo e($good_info['main_image']); ?>" width="100%" alt="">
                                <h4><?php echo e($good_info['spu_name']); ?></h4>
                                <p class="price">￥&nbsp;<?php echo e($good_info['spu_price']); ?></p>
    ...
    <form action="<?php echo e(asset('/wx/pay/orderConfirm')); ?>" method="post" id="orderConfirm">
...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('sd_js/common-top.js')); ?>"></script>
