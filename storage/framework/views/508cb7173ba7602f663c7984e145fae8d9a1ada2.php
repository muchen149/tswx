...
<?php $__env->startSection('content'); ?>
    ...
    <div id="header"></div>
    <div class="jd-wrap">
        <form id="mainForm" action="<?php echo e(asset('personal/submitApply')); ?>" method="post">
            ...
            <input id="applyType" name="applyType" type="hidden" value="<?php echo e($applyType); ?>">
        ...
        <section class="miblewrap01 goods-apply-upload">
            ...
            <script type="text/javascript" src="<?php echo e(asset('js/ajaxfileupload.js')); ?>"></script>
        </section>
...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript">
        var scriptUrl = '<?php echo e(asset('js/prefect_apply.js')); ?>';
        var uploadImgUrl = '<?php echo e(asset('personal/uploadImg')); ?>';
        var delImgUrl = '<?php echo e(asset('personal/delImg')); ?>';

        $(function () {
            var phoneReg = /^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$/;

            var applyType = '<?php echo e($applyType); ?>';
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/prefect_apply.js')); ?>"></script>
<?php $__env->stopSection(); ?>
