...
<?php $__env->startSection('css'); ?>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/after-sales.css')); ?>" charset="utf-8">
    <style>
        #tab2 {
            display: none;
        }
...
<?php $__env->startSection('content'); ?>
    ...
    <div id="tab1">
        <?php if(!$is_apply_group): ?>
            <div style="margin:0 auto;height:200px;width:200px;margin-top:50px;text-align: center">
                <img style="width:80%" src="<?php echo e(asset('img/empty_quan.png')); ?>">
                <p class="mt20" style="color:#323232;">您还不是团采商用户</p>
                <p style="margin-top:20px;text-align: center">
                    <a href="<?php echo e(asset('personal/perfectApply/groupbuy')); ?>"
        ...
        <?php else: ?>
            ...
            <?php else: ?>
                <div class='new-ct' style="margin-top:40px;">
                    <?php $__currentLoopData = $groupList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $joinin): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <?php if($joinin->apply_grade == 20): ?>
                            <div class="section">
                                <div class="s-num">申请类别：<?php echo e($joinin->apply_grade_name); ?>

                                    <a href="<?php echo e(asset('personal/joininDetail') . '/' . $joinin->id); ?>"
                                       class="btn-search">进度查询</a>
                                </div>
                                <div class="s-cont">
                                    <div class="p-name">
                                        <a><?php echo e($joinin->company_name); ?></a>
                                    </div>
                                    <span class="p-static">状态：<span
                                                class="red"><?php echo e($joinin->state_name); ?></span> <br></span>
                                    <span class="p-time">申请时间：<?php echo e(date('Y-m-d H:i:s', $joinin->created_at)); ?></span>
                                    <?php if($joinin->verify_state == 1): ?>
                                        <a val="<?php echo e($joinin->id); ?>" style="margin-right:9px;float:right"
    ...
    <div id="tab2">
        <?php if(!$is_apply_proxy): ?>
            <div style="margin:0 auto;height:200px;width:200px;margin-top:50px;text-align: center">
                <img style="width:80%" src="<?php echo e(asset('img/empty_quan.png')); ?>">
                <p class="mt20" style="color:#323232;">您还不是代理商用户</p>
                <p style="margin-top:20px;text-align: center">
                    <a href="<?php echo e(asset('personal/perfectApply/proxy')); ?>"
                       style="background:#fff;color:#323232;border:1px solid #646464;margin-top:20px;padding:8px 20px;letter-spacing:3px;border-radius: 5px;">立即申请</a>
                </p>
            </div>
        <?php else: ?>
            ...
            <?php else: ?>
                <div class='new-ct' style="margin-top:40px;">
                    <?php $__currentLoopData = $proxyList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $joinin): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <?php if($joinin->apply_grade == 30): ?>
                            <div class="section">
                                <div class="s-num">申请类别：<?php echo e($joinin->apply_grade_name); ?>
        ...
        $(function () {
            ...
            $(".btn-cancel").click(function () {
                ...
                showConfirmDialog('确定取消申请？', function () {
                    hideConfirmDialog();
                    loading();
                    var url = '<?php echo e(asset('personal/cancelApply')); ?>';
                    $.post(
                            url,
                            {id: id},
                            function (data) {
                                ...
                                if (data.code == 0) {
                                    location.href = '<?php echo e(asset('personal/joininList')); ?>';
                                }
                            },
                            'json'
                    );
