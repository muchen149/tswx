...
<div class="container">
    ...
    <div class="detail-baseInfo">
            ...
            <ul class="flex-between  color-80 border-b1 tong">
                <li class="font-12" style=""><?php if($grade==10): ?>开通<?php echo e($member_class_arr[20]['grade_name']); ?>服务立省<?php elseif($grade==20): ?>开通<?php echo e($member_class_arr[30]['grade_name']); ?>服务立省<?php elseif($grade==30): ?><?php echo e($member_class_arr[30]['grade_name']); ?>服务已为您节省<?php endif; ?><?php echo e($goods->sup_discount); ?>元</li>
                <?php if($grade < 30): ?>
                    <li><a href="<?php echo e(asset('member/buy')); ?>" class="flex-between color-80"><span class="font-12" style="padding-right: 10px;">立即开通 <span class="font-14">></span></span></a></li>
                <?php else: ?>
                    <li><a href="<?php echo e(asset('member/buy/30')); ?>" class="flex-between color-80"><span class="font-12" style="padding-right: 10px;">立即续费 <span class="font-14">></span></span></a></li>
                <?php endif; ?>
            </ul>

            <ul class="flex-between  color-80 border-b1 tong">
                <?php if(empty($goods->from_plat_name)): ?>
                    <li class="font-12">直营</li>
                <?php else: ?>
                    <li class="font-12">供应商 : <?php echo e($goods->from_plat_name); ?></li>
                <?php endif; ?>
                <?php if(!empty($tpl)): ?>
                    <?php if($tpl->isFreeDelivery == 1): ?>
                        <li><span class="font-12 pos">满<?php echo e($tpl->limitNum); ?>元包邮</span></li>
                    <?php elseif($tpl->isFreeDelivery == 2): ?>
                        <li><span class="font-12 pos">满<?php echo e($tpl->limitNum); ?>件包邮</span></li>
                    <?php elseif($tpl->isFreeDelivery == 0): ?>
                        <li><span class="font-12 pos">运费<?php echo e($tpl->limitNum); ?>元</span></li>
                    <?php endif; ?>
                <?php else: ?>
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $rmdSpuList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $good): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                            <li style="width: 33%;"><a href="<?php echo e(url('/shop/goods/spuDetail/'.$good->spu_id)); ?>">
                                    ...
                                    <h4 class="rmdGood"><?php echo e($good->spu_name); ?></h4><p class="price" style="font-size: 15px;">¥&nbsp;<?php echo e($good->spu_price); ?></p></a>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                    <?php endif; ?>
                </ul>
    ...
    <div class="bottom-menu">
        <ul>
            ...
            <li>
                <a href="<?php echo e(asset('shop/index')); ?>" id="sd_cart">
            ...
            <li>
                <a href="<?php echo e(asset('cart/index')); ?>" id="sd_cart">
                    <span class="btn-cart">
                        <?php if($goods_num_in_cart < 100): ?>
                            <span class="cart_num"><?php echo e($goods_num_in_cart); ?></span>
                        <?php else: ?>
...
<div  class="detail">
    <div class="form-gui-ge">
        ...
        <div class="col-xs-12 buy-btn">
            <form action="<?php echo e(asset('/order/showPay')); ?>" method="post" name="buyForm" id="buyForm">
        ...
        <div class="col-xs-12 share-gift">
            <form action="<?php echo e(asset('/wx/pay/orderConfirm')); ?>" method="post" name="send-gift" id="send-gift">
...
<div class="lanrenzhijia" id="pop-ad">
    <div class="content">
        <img width="270px;" height="320px" src="<?php echo e(asset('/sd_img/notice_gift.png')); ?>" usemap="#Map" />
        <map name="Map">
...
<div class="follow" id="pop-ad">
    <div class="content">
        <img width="270px;" height="332px" src="<?php echo e(asset('/sd_img/subscribe_share.jpg')); ?>" usemap="#Mapp" />
        <map name="Mapp">
...
<?php $__env->startSection('js'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('sd_js/goods/product.js')); ?>"></script>
