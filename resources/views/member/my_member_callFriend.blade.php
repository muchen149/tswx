...
<div class="mui-slider">
    <div class="mui-slider-group mui-slider-loop">
        <!--支持循环，需要重复图片节点-->
        <div class="mui-slider-item mui-slider-item-duplicate"><a href="#"><img src="http://anydo.wang/images/sp/sp4.jpg" alt=""></a></div>
        <div class="mui-slider-item"><a href="#"> <img src="http://anydo.wang/images/sp/sp1.jpg" alt=""></a></div>
        ...
        <!--支持循环，需要重复图片节点-->
        <div class="mui-slider-item mui-slider-item-duplicate"><a href="#"><img src="http://anydo.wang/images/sp/sp1.jpg" alt=""></a></div>
    </div>
