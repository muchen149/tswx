...
@if(empty($skus))
    <div class="title b-white font-16 color-50 flex-center">
        <ul class="flex-between">
            <li style="transform:rotate(180deg);margin-left: -15px;"><a href="{{asset('/elife/eLifeIndex')}}"><img src="{{asset('sd_img/next.png')}}" alt="" class="size-28"></a></li>
            <li id="openPopover" class="font-18" style="text-align: left; color: #000000">购物车</li>
            <li class="car-status1 font-14 color-80"></li>
        </ul>
    </div>
    <div style="margin:0 auto;height:200px;width:200px;margin-top:40px;text-align: center">
        <img style="width:80%" src="/sd_img/empty_quan.jpg">
        <p style="color:#bcbcbc;font-size:14px;margin-top:14px;">亲，您的购物车空空如也！</p>
    </div>
@else
    <div class="title b-white font-16 color-50 flex-center">
        <ul class="flex-between">
            <li style="transform:rotate(180deg);margin-left: -15px;"><a href="{{asset('/elife/eLifeIndex')}}"><img src="{{asset('sd_img/next.png')}}" alt="" class="size-28"></a></li>
            <li id="openPopover" class="font-18">购物车</li>
    ...
    @foreach($skus as $sku)
        <div class="goods-list b-white">
            ...
            <ul class="m">
                <a href="{{url('/elife/goods/spuDetail/'.$sku['spu_id'])}}">
    ...
    <div class="actionBar flex-between">
        ...
        <ul class='heji'>
            <li class="font-12 color-50">合计：¥&nbsp;<span class="total_price" style="color: #e42f46">0</span></li>
            {{--<li class="font-12 color-50" ><span id="jianshu">合计：<span id="shopCar-count"></span>&nbsp;件</span></li>--}}
        </ul>
...
@section('js')
    ...
    <script src="{{asset('elife_js/cart/cart_list.js')}}"></script>
