...
@section('content')
    <body>
		@if($type == 'e_bank')
		<a onclick="hybrid_app.back();">
		@else
		<a href="{{asset('/elife/personal/index')}}">
		@endif
        <ul class="nav_bar flex-between font-14 color-80">
            <li style="width: 7%;">
                <img src="{{asset('sd_img/next.png')}}" alt="" class="size-26" style="transform:rotate(180deg);">
            </li>
            <li style="padding-right: 30%;">返回</li>
            <li style="padding-right: 40%;">
                订单详情
            </li>
        </ul>
    </a>
            ...
            <ul class="flex-end">
                ...
                @elseif($order_info['plat_order_state'] == 3)
                    ...
                    @else
                        ...
                        <li class="flex-center" order_id="{{$order_info['plat_order_id']}}">确认收货</li>
                ...
                @elseif($order_info['plat_order_state']==4 || $order_info['plat_order_state']== 9)
                    ...
                    @else
                        <li class="showShipping" order_id="{{$order_info['plat_order_id']}}">查看物流</li>
...
@section('js')
	...
	<script src="{{asset('elife_js/hybrid_app.js')}}"></script>
    <script>
        $(function(){
            orderListContent();
        });
