...
@endsection
@section('css')
    <link rel="stylesheet" href="{{asset('elife_css/wuliu/header.css')}}" >
    <link rel="stylesheet" href="{{asset('elife_css/wuliu/index.css')}}" >
    <link rel="stylesheet" href="{{asset('elife_css/wuliu/footer.css')}}" >
    <link rel="stylesheet" href="{{asset('elife_css/wuliu/wuliu.css')}}">
    <style>
        /*.show-class{*/
...
@section('content')
    ...
    <div class="head">
        <div class="nav b-white">
			...
			@endif
            <a class="title font-14 color-80" href="#">物流信息</a>
        </div>
    </div>
    @if($result != null)
