...
@section('content')
    ...
    <div class="head">
        <div class="nav b-white">
            ...
            <a class="title font-18 color-80" href="#">订单确认</a>
        </div>
    </div>
    ...
    <div class="goods-count b-white" >
        <ul class="flex-between font-14 color-80">
            <li>小计</li>
            <li class="font-ber color-f53a3a">¥&nbsp;<span id="payable_amount">{{$payable_amount}}</span></li>
        </ul>
    </div>
    <div>
         <ul>
           <li><img src="{{asset('elife_img/zhifu.jpg')}}" alt="" style="width:100%;"></li>
         </ul>
     </div>
    ...
    <div class="actual-pay flex-between font-14">
        <ul class="flex">
            <li class="color-80" style="margin-left: 5px;">合计：¥&nbsp;<span class="font-14 color-f53a3a" id="zhifu-total">{{$pay_rmb}}</span></li>
        </ul>
        {{--@if($id_card == 1)--}}
        ...
        {{--@else
            ...
            <ul class="flex-center color-white zf-btn kaoLa">
                立即支付
            </ul>
        @endif--}}
    </div>
    ...
    <div id="light" class="white_content">
        <div class="title-zeng" style="border-bottom:solid 1px #d4d2d2;height: 40px">
            <p class="text-center" style="text-align: left;line-height:40%;color: #000000">实名认证</p>
            <div class="close_card close-btn " id="add-new-add" style="top: 8px">
                <img src="{{asset('img/m-close.svg')}}" height="20" width="20"/>
            </div>
        </div>
        <div class="color-80" style="margin: 13px 0px">
            <img src="{{asset('elife_img/tishi.jpg')}}"><span style="font-size: 5px;margin: 0px 5px">海关要求购买跨境商品需提供实名信息哦!</span> </div>
        ...
        <div class="color-80 id_notice">
              <div class="close_card" id="add-new-add" style="">
                   <span style="font-size: 5px;margin-left:70%;color:#aab2bd"><img src="{{asset('elife_img/yiwen.jpg')}}">了解实名认证</span>
              </div>
        </div>
        <button class="to_examine" style="width: 100%;height: 18%;background-color: #e42f46;margin-top: 4%;font-size: 18px;">
...
@section('js')
    ...
    <script src="{{asset('elife_js/order/order_confirm_pay.js')}}"></script>
