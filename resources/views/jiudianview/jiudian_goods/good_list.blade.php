                ...
                <ul class="clearFix">
                   {{-- <li>
                    ...
                    @foreach($goodsSpuList as $good)
                        <li>
                            <a href="{{url('/jd/goods/spuDetail/'.$good->spu_id)}}"><img src="{{$good->main_image}}" width="100%" alt="">
                                <h4>{{$good->spu_name}}</h4>
...
{{--    <script type="text/javascript" src="{{asset('js/common.js')}}"></script>
    ...
    <script type="text/javascript" src="{{asset('jiudian_js/jdgoods_list.js')}}"></script>
...
<script type="text/javascript">
    ...
    function pageLoad(page, rows, callback) {
        ...
        var url = "/jd/goods/ajax/spuList/"+page+"/"+rows+"/"+$('#gcId').val()+"/0/0/"+$('#gcType').val();
        $.ajax({
            url: url,
            type:'get',
            data: {},
                ...
                if (data.message.length == 0 && page == 1) {
                    ...
                    if (data != "") {
                        for (var i = 0; i < data.length; i++) {
                            ...
                            html += '<li>';
                            html += '<a href="/jd/goods/spuDetail/' + data[i].spu_id + '">';
