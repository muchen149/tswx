...
@section('content')
    ...
    <div id="header"></div>
    <div class="result-hot-pro lazyimg" id="favorites_list">
        @if(!$subjectList)
            <div style="margin:0 auto;height:200px;width:200px;margin-top:40px;text-align: center">
                ...
                <p class="mt20" style="color:#323232;">亲，您暂时还没有收藏商品或店铺！</p>
            </div>
        @else
            <ul id="productsList" class="list" style="margin-top: 10px;">
                    ...
                    <li goods_id="{{$good->subject_id}}">
                        ...
                        <div class="list-right">
                            ...
                            <div class="bottom">
                                ...
                                <img class="delete cart-list-del" src="/img/delete.png" alt="" goods_id="{{$good->subject_id}}">
                            </div>
                        </div>
                    </li>
...
@section('js')
    ...
    <script type="text/javascript" src="/js/member/collect.js"></script>
@endsection
