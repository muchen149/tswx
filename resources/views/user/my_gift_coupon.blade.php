...
@section('content')
    ...
    @else
        @foreach($giftCouponList as $coupon)
            <div class="lq-list">
                <div class="list-img">
                    <img src="{{$coupon['activity_images']}}" alt="">
                </div>
                <div class="list-text">
                    <p class="text-title">{{$coupon['activity_name']}}</p>
                    <p class="text-time">有效期至:{{$coupon['expire_time']}}</p>
                </div>
                <div class="list-control">
                    <p class="control-title">礼券</p>
                    <div class="control-btn" coupon_id="{{$coupon['giftcoupon_id']}}">
                        立即使用
                    </div>
                </div>
            </div>
