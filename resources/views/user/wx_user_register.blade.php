...
@section('content')
    ...
    <section class="page">
        <div class="wrap regPage">
            ...
            <div class="input-container">
                <input id="userpwd" type="password" class="acc-input password txt-input J_ping" placeholder="请设置6-20位登录密码" autocomplete="off" report-eventid="MLoginRegister_PasswordInput" >
                <i style="right: 0.1rem;" class="icon icon-clear"></i>
            </div>
            <div class="notice">&nbsp;</div>
            <div class="error-tips mt10"></div>
            <a href="javascript:;" id="regBtn" style="height: 45px;line-height: 30px;" class="btn J_ping" report-eventid="MLoginRegister_Finish">注 册</a>
