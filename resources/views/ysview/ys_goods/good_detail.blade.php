...
@section('css')
    ...
    <link href="{{asset('ys_css/SimpleCanleder.css')}}" rel="stylesheet" />
...
<div class="container">
    ...
    <input type="hidden" id="t_month" value="{{ $t_month }}">
    <div class="detail-baseInfo">
        <p style="font-family: 微软雅黑;font-size: 18px;font-weight: 400">{{$goods->spu_name}}</p>
        <p class="price" style="color:#bf383c;font-size: 16px;font-family: 微软雅黑;">预约费：<span style="color:#bf383c;">¥ {{$goods->spu_price}}</span>
...
<div class="bottom-menu">
    ...
    {{--<div class="bottom-menu">
        <ul>
            ...
            --}}{{--<li id="directorder_ys">
                <form action="{{asset('/ys/order/showPay')}}" method="post" name="buyForm" id="buyForm">
                    <input type="hidden" name="spuId" id="spuId">
                    <input type="hidden" name="number" id="number">
                    <input type="hidden" name="src" id="src">
                    <input type="hidden" name="guiges" id="guiges">
                    <span class="btn-buy" style="background:#c9151e;color: #fff;">立即预约</span>
                </form>
                --}}{{----}}{{--<a href="javascript:buyClick();">--}}{{----}}{{--
...
@section('js')
    ...
    <script type="text/javascript" src="{{asset('ys_js/ys_product.js')}}"></script>
