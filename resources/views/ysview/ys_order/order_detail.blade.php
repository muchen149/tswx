...
@section('content')
    ...
    <div class="order-list">
        ...
        @foreach($order_info['skus'] as $goods)
            <a href="/ys/goods/spuDetail/{{$goods['spu_id']}}/{{$OrderExtend->month}}">
        ...
        @endforeach
            ...
            <div class="select-time" style="font-size: 12px;background-color: white;">
                ...
                <span>月份：</span>{{$OrderExtend->month}}
        ...
        <div class="order-list-optionBar font-12 color-80 b-white">
            <ul class="flex-end">
                ...
                @elseif($order_info['plat_order_state']==4 || $order_info['plat_order_state']== 9)
                    ...
                    @else
                        <li class="show_shipping" order_id="{{$order_info['plat_order_id']}}">查看物流</li>
