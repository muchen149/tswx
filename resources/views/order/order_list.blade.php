...
<body>
    ...
    <div class="nav-order">
        <div class="nav-title">
            <div class="nav-content border-right @if(empty($state)) current @endif" state="0"><a href="/order/index">全部</a></div>
            <div class="nav-content border-right @if($state == '1') current @endif" state="1"><a href="/order/index/1">待付款</a></div>
            <div class="nav-content border-right @if($state == '2') current @endif" state="2"><a href="/order/index/2">待发货</a></div>
            <div class="nav-content border-right @if($state == '3') current @endif" state="3"><a href="/order/index/3">待收货</a></div>
            <div class="nav-content border-right @if($state == '9') current @endif" state="9"><a href="/order/index/9">已完成</a></div>
                        ...
                        <div class="order-lcnt">
                            ...
                            @foreach($order_info['skus'] as $goods)
                                <div class="order-shop-pd">
                                    <a href="{{asset('order/info/'.$order_info['plat_order_id'])}}" class="order-ldetail clearfix ">
                                               <span class="order-pdpic">
                                                            <img src="{{asset($goods['sku_image'])}}">
                                               </span>
                                        <div class="order-pdinfor">
                                            <p>{{$goods['sku_name']}}</p>
                                            <p style="height:29px;color: #8e8e8e;font-size: 12px;">
                        ...
                        <div class="order-status">
                            ...
                            @elseif($order_info['plat_order_state']==3)
                                ...
                                @if($order_info['pay_mode_id'] == 5 || $order_info['pay_mode_id'] == 8)
                                    ...
                                    <input type="hidden" value="{{$order_info['plat_order_id']}}"/>
                                @else
                                    <span class="sure_order" order="{{$order_info['plat_order_id']}}">确认收货</span>
                                @endif
