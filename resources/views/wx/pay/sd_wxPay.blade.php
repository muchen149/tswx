...
<div class="express b-white">
    <ul class="flex-between font-14 color-50 borderBottom">
        <li>订单金额：</li>
        <li>¥&nbsp;{{$plat_order->payable_amount}}</li>
    </ul>
</div>
...
@if(isset($arr_payment_info['pay_vrb']))
    <div class="express b-white">
        <ul class="flex-between font-14 color-50 borderBottom">
            <li>{{$plat_vrb_caption}}抵：</li>
            <li> ¥&nbsp;{{$arr_payment_info['pay_vrb']['pay_amount_to_rmb']}}</li>
        </ul>
    </div>
@endif
@if(isset($arr_payment_info['pay_wallet']))
    ...
    <div class="express b-white">
        <ul class="flex-between font-14 color-50 borderBottom">
            <li>零钱支付：</li>
            <li>¥&nbsp;{{$arr_payment_info['pay_wallet']['pay_amount']}}
            </li>
        </ul>
    </div>
@endif
...
@if(isset($arr_payment_info['org_pay_card']))
    <div class="express b-white">
        <ul class="flex-between font-14 color-50 borderBottom">
            <li>机构卡抵：</li>
            <li>
                ¥&nbsp;{{$arr_payment_info['org_pay_card']['pay_amount']}}
            </li>
        </ul>
    </div>
...
<div class="express b-white marginBottom">
    <ul class="flex-between font-14 color-50 ">
        <li>实付金额：</li>
        <li> ¥&nbsp;{{$plat_order->pay_rmb_amount}}</li>
    </ul>
</div>
...
<div class="express b-white mode-of-payment" p_mode = 'WechatPay' is-chose="1">
    <ul class="flex-between font-14 color-50">
        ...
        <li><img src="{{asset('img/selected.png')}}" height="24" class="child_img"/></li>
    </ul>
</div>

{{--<div class="express b-white mode-of-payment" p_mode = 'WechatPay' is-chose="0">--}}
    {{--<ul class="flex-between font-14 color-50">--}}
        {{--<li>--}}
            {{--<img src="{{asset('img/m-weixin.svg')}}" height="28" width="28"/>--}}
        ...
        {{--<li><img src="{{asset('img/defau.png')}}" height="24" class="child_img"/></li>--}}
    {{--</ul>--}}
{{--</div>--}}
