...
//        ]);
        ...
        return view("ysview.ys_mall.welcome", compact('advertList', 'goodsSpuList', 'queryParameter', 'separatePage', 'plat_vrb_caption','signPackage'));
    }
    ...
    private function spuQuery($pageNumber = 1, $pageSize = 10, $gcId = 0, $goodsName = '', $orderBy = 0,$gcType=0)
    {
        ...
        */
        ...
        $where = ' where a.state = 1  and a.good_type=2 ';
        if ($gcId) {
            if($gcType==1){
    ...
    return view("jiudianview.jiudian_goods.good_list", compact('goodsSpuList', 'queryParameter', 'separatePage', 'goodsName', 'orderBy'));
}
    ...
    public function spuDetail($spuId = 0)
    {
        ...
        */
        ...
        $spec_name = unserialize($goods->spec_name);
        ...
        return view("jiudianview.jiudian_goods.good_detail",
            compact('goods', 'spuSpec', 'spuAttr', 'spuImages', 'collect_status', 'plat_vrb_caption', 'goods_num_in_cart',
                'signPackage', 'share_link', 'stoken','isHighest','nextPriv','skus'));
    }
    ...
    public function goodDetail(Request $request)
    {
        ...
        return view('jiudian_goods.good_mobile_content', compact('mobilecontent'));
    ...
    public function getSku(Request $request)
    {
        ...
        */
        ...
        $info_sql = "SELECT g.sku_id,g.sku_name,g.sku_title,
                     ...
                     and not EXISTS (select * from " . $db_prefix . "sku_soldrecord rcd where  rcd.sold_date between '" . $enterdate . "' and '" . $leavedate . "' and rcd.sku_id = g.sku_id ) ORDER BY g.sku_id";
        $skus = DB::select($info_sql);
    ...
    */
    ...
    function chekcSkus(Request $request){
        ...
        foreach ($skus as $sku) {
            ...
            $num=DB::table("sku_soldrecord")->whereBetween('sold_date',[$enterdate,$leavedate])->where('sku_id',$array_sku[0])->count();
