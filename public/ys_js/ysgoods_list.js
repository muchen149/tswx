...
$("select[name=page_list]").change(function () {
    ...
    var url = "/ys/goods/spuList/"+cpage+"/10/"+gcId+"/0/"+orderBy+"/"+gcType;
...
$('.keyorder').click(function () {
 ...
 //当点击某个排序规则时，显示的是该规则的第一页
    var url = "/ys/goods/spuList/1/10/"+gcId+"/"+keyword+"/"+order+"/"+gcType;
...
$('.pre-page').click(function () {//上一页
    ...
    var url = "/ys/goods/spuList/"+cpage+"/10/"+gcId+"/"+keyword+"/"+orderBy+"/"+gcType;
...
$('#keyword').keydown(function (event) {
    if (event.keyCode == 13) {
        var keyword = encodeURIComponent($('#keyword').val());
        var url = "/ys/goods/spuList/1/10/0/"+keyword;
        location.href = url;
    }
});
$('.search-btn1').click(function () {
    var keyword = encodeURIComponent($('#keyword').val());
    if(keyword==''){
        var url = "/ys/goods/spuList/1/10/"+gcId;
        ...
        var url = "/ys/goods/spuList/1/10/"+gcId+"/"+keyword+"/"+orderBy+"/"+gcType;
